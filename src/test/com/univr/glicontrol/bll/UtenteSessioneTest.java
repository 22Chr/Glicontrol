...
class UtenteSessioneTest {
    ...
    void creaAdminConnesso() {
        UtenteSessione utenteSessione = UtenteSessione.getInstance();
        Admin admin = utenteSessione.creaAdminConnesso("CHCCRS03L22F861M", "SagradaFam", "ADMIN");
        assertNotNull(admin);
    ...
    void creaMedicoConnesso() {
        UtenteSessione utenteSessione = UtenteSessione.getInstance();
        Medico medico = utenteSessione.creaMedicoConnesso("MBRSFO03H51E349E", "Gelato9876", "MEDICO");
    ...
    void creaPazienteConnesso() {
        UtenteSessione utenteSessione = UtenteSessione.getInstance();
        Paziente paziente = utenteSessione.creaPazienteConnesso("MRTNNA04A62H612X", "CalDigit04", "PAZIENTE");
